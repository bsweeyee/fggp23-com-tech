...
public partial class GameSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        if (GameDataEntity == Entity.Null)
        {
            ...
            {
                var gameDataComponent = gd;
                GameStateComponent gameStateComponent;
                CameraData cameraData;

                DynamicBuffer<CurveBufferData> cbd = SystemAPI.GetBuffer<CurveBufferData>(entity);
                gameStateComponent = SystemAPI.GetComponent<GameStateComponent>(entity);
                ...
                EntityManager.SetComponentData(entity, gameStateComponent);
                ...
                cameraData = SystemAPI.GetComponent<CameraData>(entity);                               
